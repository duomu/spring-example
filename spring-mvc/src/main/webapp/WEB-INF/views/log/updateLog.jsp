...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-8 blog-main">
            <form role="form" method="post" action="${ctx}/log/updateLog">
                <!--存储CSRF token-->
                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                <input type="hidden" name="id" value="${log.id}">
                <div class="form-group">
                    <label for="tile">标题</label>
                    <input type="text" class="form-control" id="tile" name="title" value="${log.title}" placeholder="请输入标题">
                </div>
                <div class="form-group">
